...
function onFormSubmit(){
		if(!isRadioChecked(shipmentForm.addressId,MSG_SHIPMENT_ADDRESS)){			
			}
			else{
		shipmentForm.action="<%=request.getContextPath()%>/orderShipmentAddressCreate.do";
		shipmentForm.submit();
		} }
						...
						<TABLE cellspacing="0" cellpadding="0" border="0" width="100%">
							<TBODY>
								<TR>
									...
									<FORM name="shipmentForm" method="post" onsubmit="return onFormSubmit(this)">
									<TABLE border="0" width="100%">
										<TBODY>
											<TR>
												<TD colspan="3" class="topmenu"><IMG border="0"
													src="<%=request.getContextPath()%>/image/application/arrow.png"
													width="9" height="9">&nbsp;<bean:message key="Address.Header.shipment"/><BR>
												<BR>
												</TD>
											</TR>
											<TR>
											...
											<TR>
												...
												<BR></TD></TR>
											<TR>
												<TD class="topTitle" colspan="3"><INPUT type="checkbox"
													name="paymentAddress" value="1">Teslimat Adresim ve Fatura Adresim ayný</TD>
											</TR>
											<TR>
											...
											<TR>
												<TD width="31"><INPUT type="radio" name="addressId" value="<%=((TbAddress)addressList.get(z)).getId()%>">&nbsp;</TD>
												<TD colspan="2" width="475"><A
													href="<%=request.getContextPath()%>/userAddressDetails.do?addressId=<%=((TbAddress)addressList.get(z)).getId()%>"><%=((TbAddress)addressList.get(z)).getShortName()%></A></TD></TR>
											<TR>
												<TD width="31"></TD>
											...
											<TR>
												<TD colspan="3" align="right"><IMG border="0"
													src="<%=request.getContextPath()%>/image/application/spacer6.gif"
													height="1"><%}%> <A class="butonlar"
													href="#" onclick="onFormSubmit()"><bean:message key="Menu.continue.button" /></A> <% }else{ %></TD>
											</TR>
											<TR>
											...
											<TR>
												<TD colspan="3" align="center"><A class="butonlar"
													...
													border="0"
													src="<%=request.getContextPath()%>/image/application/shipaddress.gif"

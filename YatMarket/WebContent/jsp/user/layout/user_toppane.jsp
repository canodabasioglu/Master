							...
							<TBODY>
								<TR valign="middle">
									...
									<TD align=center width=50><A href="#" onclick="onFormSubmitMail()"><IMG border="0"
										...
										height="19" width="22" alt="Aramak istediðiniz ürünü yazdýktan sonra týklayýnýz."></A>
									</TD>
							</TBODY>
						</TABLE>
							...
							<TBODY>
								<TR valign="middle">
									...
									<TD class="top_bar" align="center" width="87"><A class=top_bar
										href="<%=request.getContextPath()%>/userLogout.do"><bean:message key="Menu.logout"/></A></TD>
								</TR>
							</TBODY>
						</TABLE>
						</TD>

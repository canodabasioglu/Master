				...
				<TBODY>
					<TR vAlign=top>
						...
						<TABLE cellspacing="0" cellpadding="0" border="0" width="100%">
							<TBODY>
								<TR>
									<TD width="580" valign="top" align="center"><%=com.odabasioglu.utility.MessageUtility
								.getMessage(request.getAttribute("message"))%><BR>
									<jsp:include page="/jsp/common/mainPage.jsp" flush="true" /></TD>
								</TR>
							</TBODY>
						</TABLE>
						</TD>
						...
						<TD valign="top" width="200"><jsp:include
							page="/jsp/user/layout/user_rightpane.jsp" flush="false" /></TD>
					</TR>
				</TBODY>
			</TABLE>
			</TD>

 ...
 * @author
 */
public class OrderPaymentAddressCreateAction extends Action {
	private static final String actionRight = "OrderPaymentAddressCreateAction";
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			if (AuthorizationManager
				...
				Integer paymentAddressId = Integer.valueOf(request
						.getParameter("addressId"));
				TbOrder order = (TbOrder) session.getAttribute("order");
				order.setPaymentAddress(paymentAddressId);
			...
			Logger.getLogger(OrderPaymentAddressCreateAction.class).error(

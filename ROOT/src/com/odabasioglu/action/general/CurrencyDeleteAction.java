 ...
 * @author
 */
public class CurrencyDeleteAction extends Action {
	private static final String actionRight = "CurrencyDeleteAction";
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			if (AuthorizationManager
				...
				Integer currencyId = Integer.valueOf(request.getParameter("id")
						.trim());

				currencyDAO.delete(currencyId);
				request.setAttribute("message", "Success.currency.delete");
			...
			Logger.getLogger(CurrencyDeleteAction.class).error(
					"Exception in Action : " + e);
			LogManager.logError(e.getMessage());
			request.setAttribute("message", "Error.currency.delete");
			forward = mapping.findForward("listCurrency");

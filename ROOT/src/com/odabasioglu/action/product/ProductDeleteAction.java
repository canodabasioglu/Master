...
public class ProductDeleteAction extends Action {
	private static final String actionRight = "ProductDeleteAction";
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		try {
			if (AuthorizationManager
				...
				request.setAttribute("message", "Success.product.delete");
			...
			request.setAttribute("message", "Error.product.delete");
			Logger.getLogger(ProductDeleteAction.class).error(

...
public abstract class _BaseRootDAO {
	...
	public static void initialize() throws HibernateException {
		initialize("/com/odabasioglu/config/hibernate.cfg.xml");
	}
	 ...
	 * Set the session factory
	 */
	protected static void setSessionFactory(
	...
	private static SessionFactory getSessionFactory(String configFile)
		...
		if (sessionFactoryMap.size() == 1)
			...
			SessionFactory sessionFactory =
				(SessionFactory) sessionFactoryMap.get(configFile);
	...
	public java.util.List find(String query, Session s)
		...
		// deprecated:	return s.find(query);
	}
	 ...
	 */
	protected java.util.List findFiltered(
		String propName,
		Object filter,
	 ...
	 * @return Query
	 */
	public java.util.List getNamedQuery(
		String name,
		Serializable[] params,
		Session s)
		throws HibernateException {
	...
	public java.util.List find(String query, Object obj, Type type, Session s)
		throws HibernateException {
		return find(query, new Object[] { obj }, new Type[] { type }, s);
		// deprecated: return s.find(query, obj, type);
	}
